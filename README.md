...
```javascript
import isNamedTypedTupleLike from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-named-typed-tuple-like@v0.2.3-deno/mod.js';
```
...
[@stdlib/dstructs/named-typed-tuple]: https://github.com/stdlib-js/dstructs-named-typed-tuple/tree/deno
